...
class FSANet(nn.Module):
    def __init__(self, S_set):
        ...
        self.capsule_layer = CapsuleLayer(in_units=self.num_primcaps, in_channels=64, num_units=self.num_capsule,
    ...
    def forward(self, x, alpha):
        ...
        primcaps_s1 = PrimCaps(
            [S_matrix_s1, feat_pre_concat, norm_S_s1])  # (-1,c/3,8*8*3) @ (-1,64*3,64) -> (-1,c/3,64)
        ...
        return self.ssr_layer([pred_s1, pred_s2, pred_s3, delta_s1, delta_s2, delta_s3,
                               local_s1, local_s2, local_s3]), domain_output